...
{float(Canopy_object.Nitrogen_Carbon_Ratio):.3f},{float(Canopy_object.delta):.3f},\
{float(Canopy_object.Relative_Shoot_Activity):.3f},\
{float(Leaf_object.specific_Leaf_n_output['Specific_Leaf_N_Top']):.3f},\
{float(Canopy_object.Nitrogen_Demand_Activity_Driven):.3f},\
...
{float(Canopy_object.Carbon_Shoot):.3f},\
{float(Canopy_object.Root_CarbonReserve):.3f},\
{float(Canopy_object.Total_Root_Carbon):.3f},\
{float(Root_object.nitrogen_determined_Root_Carbon):.3f},\
